  ...
  $.getScript("//code.jquery.com/ui/1.10.1/jquery-ui.min.js", function(){
...
function genQuery(){
        ...
        //$(".CodeMirror").remove();
        //$("#sparql_code").text(query);
        //$("#sparql_code").val(query);
        //$("#sparql_code").val(query);
